...
\ifnum\areEqual{\jobType}{Perl}
    My main focus in recent years has been with PHP and Javascript
    development with and without various MVC frameworks
    including Symfony, Zend Framework, YII, Laravel and Ruby on Rails.
    In the past I have used several high level languages including
    \textbf{Perl}, Python, Ruby, C, C++ and Object Pascal.
\else\
    ...
    including Symfony, YII, Laravel (and Ruby on Rails).
\fi
...
\ifnum\areEqual{JobTYpe}{Perl}
Development of textbf{Perl} server to issue hostname
redirects for internal services.
\fi
...
data gathering sites with PHP and some
\boldIf{\jobType}{Perl}{Perl}
and Python, XML and JQuery.
